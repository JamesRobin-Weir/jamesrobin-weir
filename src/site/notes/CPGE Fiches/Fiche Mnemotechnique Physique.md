---
{"dg-publish":true,"permalink":"/cpge-fiches/fiche-mnemotechnique-physique/","dg-note-properties":{}}
---
...
## Chapitres
## [[CPGE Fiches/OSCILLATEURS\|OSCILLATEURS]]
## [[CPGE Fiches/Quantique\|Quantique]]
## [[CPGE Fiches/Ondes Electromagnetiques\|Ondes Electromagnetiques]]
## [[CPGE Fiches/Diffusion\|Diffusion]]
## [[CPGE Fiches/Thermodynamique\|Thermodynamique]]
## [[CPGE Fiches/Ondes matériels\|Ondes matériels]]
## [[CPGE Fiches/Mécanique des fluides\|Mécanique des fluides]]
## [[CPGE Fiches/Optique\|Optique]]
## [[CPGE Fiches/Electricité\|Electricité]]
...
- $\vec{rot}(\vec{A})=\vec{0}$ <=> $\exists \phi$ tq $\vec{A}=-\vec{grad}(\phi)$ donc $\vec{rot}(\vec{grad}(\phi))=\vec0$ 
