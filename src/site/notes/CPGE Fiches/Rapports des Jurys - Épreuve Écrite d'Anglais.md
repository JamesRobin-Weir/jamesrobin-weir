---
{"dg-publish":true,"permalink":"/cpge-fiches/rapports-des-jurys-epreuve-ecrite-d-anglais/","dg-note-properties":{}}
---
...
- Pronoms & possession : éviter les contresens de référence (his mother $\ne$ her mother du narrateur, génitif mal placé).
- Ordre des mots : syntagmes nominaux complexes (now-devastated flat ; relatives appositives in which), questions indirectes sans inversion (…asks me what I am doing…).
- Lexique transparent/pièges : soldat → soldier (pas military man), devastated (pas devasted), éviter calques (to arrest $\ne$ stop). Orthographe : which, apartment, to/too.

---

## Q1 : Question de compréhension (= 80 mots $\pm$ 10%)
...
## Q2 : Expression personnelle / Essay ( = 180 mots $\pm$ 10%)
