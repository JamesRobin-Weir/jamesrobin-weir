---
{"dg-publish":true,"permalink":"/espci-zi-bs/caracterisation-de-batteries/","dg-note-properties":{}}
---
...
Sommaire hiérarchisé des principales méthodes de caractérisation des batteries Li-ion / Li métal / Na-ion utilisées en recherche (voir [[ESPCI ZIBs/Comment comparer differentes batteries\|Comment comparer differentes batteries]] pour les grandeurs fréquemment utilisés) :

---
## **1. Méthodes électrochimiques fondamentales pour la batterie**

### 1.1. [[ESPCI ZIBs/Cyclage galvanostatique\|Cyclage galvanostatique]] (charge-décharge)
...
### 1.3. [[ESPCI ZIBs/Spectroscopie d'impedance electrochimique (SIE)\|Spectroscopie d'impedance electrochimique (SIE)]]
...
- Utile pour caractériser la nucléation du lithium et la formation de la [[ESPCI ZIBs/SEI\|SEI]] en milieux organique
...
### 2.2. Microscopies électroniques (MEB/[[ESPCI ZIBs/Transmission Electron Microscopy\|Transmission Electron Microscopy]])

- Observation des morphologies à la surface de l'électrode, et des dégradations
- [[ESPCI ZIBs/Transmission Electron Microscopy\|Transmission Electron Microscopy]] operando (durant la réaction) permet de visualiser la migration d’ions en temps réel en utilisant une micro-chambre de réaction
...
### 2.3. Calcul des [[ESPCI ZIBs/Isothermes d'adsorption\|Isothermes d'adsorption]]
