...
### 1.1. [[Weirsite/Cyclage galvanostatique\|Cyclage galvanostatique]] (charge-décharge)
...
### 1.3. [[Weirsite/Spectroscopie d'impedance electrochimique (SIE)\|Spectroscopie d'impedance electrochimique (SIE)]]
...
### 2.2. Microscopies électroniques (MEB/[[Weirsite/Transmission Electron Microscopy\|Transmission Electron Microscopy]])

- Observation des morphologies à la surface de l'électrode, et des dégradations
- [[Weirsite/Transmission Electron Microscopy\|Transmission Electron Microscopy]] operando (durant la réaction) permet de visualiser la migration d’ions en temps réel en utilisant une micro-chambre de réaction
...
### 2.3. Calcul des [[Weirsite/Isothermes d'adsorption\|Isothermes d'adsorption]]
