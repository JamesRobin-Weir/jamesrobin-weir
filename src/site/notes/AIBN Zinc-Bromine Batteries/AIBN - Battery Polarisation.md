...
Polarisation describes the operational $\Delta V$ between the battery’s two terminals inducing $\vec{E}$ that opposes the spontaneous ionic diffusion, as opposed to the theoretical equilibrium potentials. 
...
![AIBN_Battery_Polarisation.png](/img/user/Excalidraw/AIBN_Battery_Polarisation.png)
...
Mitigation strategies include increasing electrode catalytic activity, increasing active specific surface area and/or electrolyte concentration (therefore strengthening the electronic [[AIBN Zinc-Bromine Batteries/AIBN - Double layer and zeta potential\|double layer]]), raising operating temps and using catalysts. 
...
![AIBN_Concentration_permeability.png](/img/user/Excalidraw/AIBN_Concentration_permeability.png)
