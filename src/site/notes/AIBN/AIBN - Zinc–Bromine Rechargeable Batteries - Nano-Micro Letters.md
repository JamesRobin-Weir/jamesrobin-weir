...
- The authors stated that the residual zinc left on the anode after discharge results in the loss of 3–5% of the amp-hour capacity. 
...
1) strategies to prevent the formation and  growth of zinc dendrites
2) strategies to mitigate the adverse effects generated by zinc dendrites
3) strategies to suppress zinc dendrites and ultimately produce processes without dendrites

- Dendrites ==form on the membrane side==
